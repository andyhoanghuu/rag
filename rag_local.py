...
DATA_PATH = "data/"
PDF_FILENAME = "data.pdf" # Replace with your PDF filename
...
def create_rag_chain(vector_store, llm_model_name="qwen3.5:4b", context_window=8192):
    ...
    template = """Bạn là trợ lý ảo của ngân hàng SHB. Hãy sử dụng những dữ liệu được cung cấp để trả lời:
{context}
...
if __name__ == "__main__":
    ...
    # print(f"Document chunks created: {(chunks)}")
    ...
    # 5. Create RAG Chain
    rag_chain = create_rag_chain(vector_store, llm_model_name="qwen3.5:4b") # Use the chosen Qwen 3 model

    # 6. Query
    query_question = "Các phương thức thanh toán?" # Replace with a specific question
